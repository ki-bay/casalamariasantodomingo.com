...
import { PROPERTY, AMENITIES, HOUSE_RULES, POLICIES, LONG_STAY_DISCOUNTS, BOOKED_DATES } from "@/lib/data";
        ...
        <div className="md:col-span-2 space-y-12">
          <ScrollReveal>
            ...
            <h2 className="font-serif text-2xl md:text-[30px] tracking-tight mb-6">
              Un rincón de historia <em className="italic">con alma moderna</em>
            </h2>
            <div className="space-y-4 text-warm-muted text-sm leading-relaxed font-light">
              <p>{PROPERTY.description}</p>
              <p>
                El apartamento de {PROPERTY.size}m² está diseñado para parejas o
                viajeros solos que buscan una experiencia íntima y cultural en el
                corazón del Distrito Colonial, declarado Patrimonio de la
                Humanidad por la UNESCO. Cada detalle ha sido cuidadosamente
                seleccionado: desde la ropa de cama de algodón egipcio hasta las
                obras de arte de artistas dominicanos locales.
              </p>
              <p>
                Desde tu puerta, caminas directamente al Alcázar de Colón, la
                Catedral Primada de América, el Panteón Nacional y decenas de
                restaurantes, cafés y galerías de arte. La Playa Güibia está a
            ...
            <div className="bg-white rounded-2xl border border-warm-border p-6 shadow-[0_2px_20px_-10px_rgba(0,0,0,0.03)]">
              <div className="flex items-baseline justify-between mb-5">
                <div>
                  ...
                  <span className="text-sm text-secondary"> / noche</span>
                </div>
