export const PROPERTY = {
  ...
  slug: "casa-la-maria",
  description:
    "Casa La Maria ofrece cinco exclusivos apartamentos ubicados en una edificación restaurada nuevamente, rescatando el valor histórico de su estructura original en la emblemática Calle Parmenio Troncoso. Nuestro espacio combina la autenticidad de los muros de piedra coralina con un diseño interior contemporáneo de líneas limpias. Con opciones de 1 y 2 habitaciones, estos apartamentos están diseñados para alojar desde 1 hasta 4 personas, ofreciendo una experiencia íntima y cultural ideal para parejas, viajeros solos o grupos pequeños en el corazón del Distrito Colonial, declarado Patrimonio de la Humanidad por la UNESCO. Cada detalle ha sido cuidadosamente seleccionado: desde la ropa de cama de algodón egipcio hasta las obras de arte de artistas dominicanos locales. Desde tu puerta, caminas 5 min directamente al Alcázar de Colón, la Catedral Primada de América, el Panteón Nacional y decenas de restaurantes, cafés y galerías de arte. La Playa Güibia está a solo 25 minutos a pie.",
  shortDescription:
    "",
...
export const PROPERTY_EN = {
  description:
    "Casa La Maria offers five exclusive apartments housed in a newly restored building, reclaiming the historic value of its original structure on the iconic Calle Parmenio Troncoso. Our space blends the authenticity of coral-stone walls with a contemporary interior design of clean lines. With 1- and 2-bedroom options, these apartments are designed to host 1 to 4 guests, offering an intimate and cultural experience ideal for couples, solo travelers or small groups in the heart of the Colonial District — a UNESCO World Heritage Site. Every detail has been carefully selected: from Egyptian cotton bed linens to works by local Dominican artists. From your door, you walk 5 min directly to the Alcázar de Colón, the Catedral Primada de América, the Panteón Nacional and dozens of restaurants, cafés and art galleries. Playa Güibia is just 25 minutes on foot.",
  shortDescription: "",
};
